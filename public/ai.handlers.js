...
(function () {
  ...
  {
    const element = document.getElementById('ai-handler-1');
    if (element) element.addEventListener('click', function(event) {
  ...
  {
    const element = document.getElementById('ai-handler-2');
    if (element) element.addEventListener('click', function(event) {
  ...
  {
    const element = document.getElementById('ai-handler-3');
    if (element) element.addEventListener('click', function(event) {
      const result = (function(event) { swHardReset() }).call(this, event);
      if (result === false) { event.preventDefault(); event.stopPropagation(); }
    });
  ...
  {
    const element = document.getElementById('ai-handler-4');
    if (element) element.addEventListener('click', function(event) {
      const result = (function(event) { logout() }).call(this, event);
      if (result === false) { event.preventDefault(); event.stopPropagation(); }
    });
  ...
  {
    const element = document.getElementById('ai-handler-5');
    if (element) element.addEventListener('click', function(event) {
